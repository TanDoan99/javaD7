...
<div class="banner">				
	 <div class="header">  
		  <div class="container">
			  <div class="logo">
					<a href="<%=request.getContextPath()%>/IndexController"> <img src="images/logo.png" title="soup" /></a>
			 </div>
			 <!---start-top-nav---->
			 <div class="top-menu">
				  <span class="menu"> </span> 
				   <ul>
						<li><a href="<%=request.getContextPath()%>/IndexController">Trang chủ</a></li>							
	 ...
	 <div class="container">
		 ...
		 <div class="banner-links">
			 <ul>
				 <li class="active"><a href="<%=request.getContextPath()%>/IndexController">Những người bạn</a></li>
